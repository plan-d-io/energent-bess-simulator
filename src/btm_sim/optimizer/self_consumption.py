"""Self-consumption-first sequential LP (production: HiGHS)."""
...
from btm_sim.optimizer.reporting import write_self_consumption_outputs
...
def optimize_self_consumption(
    ...
    *,
    ...
    result = get_production_backend().optimize_self_consumption(
